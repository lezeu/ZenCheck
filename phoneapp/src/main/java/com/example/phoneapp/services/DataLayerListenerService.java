package com.example.phoneapp.services;
...
import com.example.phoneapp.services.handlers.BpmDataHandler;
import com.example.phoneapp.services.handlers.DataHandler;
...
public class DataLayerListenerService extends WearableListenerService implements DataClient.OnDataChangedListener {
    ...
    private void registerDataHandlers() {
        dataHandlerMap.put("/sensor-data/bpm", new BpmDataHandler());
